      ...
      <ul class="space-y-2 font-medium">
        ...
        <div data-popover id="programs-popover" role="tooltip"
          ...
          <div class="px-3 py-1">
            <ul class="py-2 grid grid-flow-col grid-rows-3 gap-3">
              <li class="row-span-1">
                <button data-modal-target="year-term-modal" data-modal-toggle="year-term-modal"
                  class="flex justify-center items-center w-full p-2 px-12 text-corn-flower-blue transition duration-300 ease-in-out rounded-lg hover:bg-ghost-lavender bg-ghost-white hover:text-neon-blue">BSIT</button>
              </li>
              <li class="row-span-1">
                <a href="#" type="button"
                  class="flex justify-center items-center w-full p-2 px-12 text-corn-flower-blue transition duration-300 ease-in-out rounded-lg hover:bg-ghost-lavender bg-ghost-white hover:text-neon-blue">BSCS</a>
              </li>
              <li class="row-span-1">
                <a href="#" type="button"
                  class="flex justify-center items-center w-full p-2 px-12 text-corn-flower-blue transition duration-300 ease-in-out rounded-lg hover:bg-ghost-lavender bg-ghost-white hover:text-neon-blue">BSCS</a>
        ...
        <div data-popover id="users-popover" role="tooltip"
          ...
          <div class="px-3 py-1">
            <ul class="py-2 grid grid-flow-col grid-rows-3 gap-3">
              <li class="row-span-1">
                <a href="./admin-user-student.php" type="button"
              ...
              <li class="row-span-1">
                <a href="./admin-user-instructor.php" type="button"
              ...
              <li class="row-span-1">
                <a href="./admin-user-admin.php" type="button"
        ...
        <div data-popover id="sections-popover" role="tooltip"
          ...
          <div class="px-3 py-1">
            <ul class="py-2 grid grid-flow-col grid-rows-3 gap-3">
              <li class="row-span-1">
                <button data-modal-target="section-modal" data-modal-toggle="section-modal"
                  class="flex justify-center items-center w-full p-2 px-12 text-corn-flower-blue transition duration-300 ease-in-out rounded-lg hover:bg-ghost-lavender bg-ghost-white hover:text-neon-blue">BSIT</button>
              </li>
              <li class="row-span-1">
                <a href="#" type="button"
      ...
      <div class="relative bg-ghost-white rounded-2xl shadow">
        ...
        <div class="p-4 md:p-5">
              ...
              <div class="relative bg-white rounded-2xl py-7 px-7">
                <div class="p-4 md:p-5">
                  ...
                  <div class="flex gap-4 pt-8">
                    ...
                    <!-- Continue -->
                    <button data-modal-hide="add-program-modal" data-modal-target="add-program-success-modal"
                      data-modal-toggle="add-program-success-modal" type="submit"
              ...
              <div class="relative bg-white rounded-2xl py-8">
                <div class="p-4 md:p-5">
                  ...
                  <div class="flex justify-center">
                    <button data-modal-hide="add-program-success-modal" type="button"
          ...
          <ul class="px-5 py-5 gap-6 grid grid-cols-3">
            <!-- Program Card 1 -->
            <div
              class="relative block p-6 bg-white rounded-2xl hover:shadow-[15px_15px_30px_-3px_rgba(224,227,246)] transition duration-700 ease-in-out col-span-1 overflow-y-auto border-b-4 border-transparent hover:border-neon-blue flex flex-col justify-between cursor-pointer">
              <div data-modal-target="year-term-modal" data-modal-toggle="year-term-modal">
                <h1 class="text-xl font-bold text-neon-blue bg-ghost-lavender px-4 py-3 rounded-xl text-center">BSIT
                </h1>
                <h5 class="mt-4 text-base font-normal tracking-tight text-corn-flower-blue">Bachelor of Science in
              ...
              <div class="flex justify-end items-center">
                <button type="button" id="dropdown-button-1" data-dropdown-toggle="dropdown-menu-1"
                  ...
                  <svg class="w-7 h-7 text-deep-koamaru" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
              ...
              <ul class="py-2 text-sm text-deep-koamaru" aria-labelledby="dropdown-button-1">
                ...
                <li>
                  <button
                    ...
                    data-modal-target='archive-program-modal' data-modal-toggle='archive-program-modal'>Archive
                    Course
                  </button>
                </li>
              </ul>
