        ...
        <div class="col-span-2">
          ...
          <div class="w-full h-auto bg-white rounded-xl shadow-[10px_10px_30px_-16px_rgba(224,227,246)] p-4 md:p-6">
            <div class="flex justify-between mb-5">
              <div>
                <h5 class="leading-none text-3xl font-bold text-corn-flower-blue pb-2">User Analytics</h5>
            ...
            <div
              ...
              <ul class="mt-6 space-y-4 overflow-y-auto max-h-full">
                ...
                $actionMapping = [          // First time to use associative array. Galing now ko lang nalaman :))
                  ...
                  "Section Creation" => "added new sections",
                  "Section Deletion" => "deleted sections"
                ];

                if ($result->num_rows > 0) {
                  while ($row = $result->fetch_assoc()) {
                    $actionSentence = isset($actionMapping[$row["Action"]]) ? $actionMapping[$row["Action"]] : $row["Action"];
                    $phrase = $row["Action"] == "Program Implementation" || $row["Action"] == "Program Archiving" || $row["Action"] == "Section Creation" || $row["Action"] == "Section Deletion" ? "with a program code of" : "with a username of";
