  ...
  <div class="p-4 sm:ml-64">
    <div class="pt-4 px-5 rounded-2xl mt-14">
      ...
      <div class="p-4 bg-white rounded-2xl mt-12">
        ...
        <div class="grid grid-cols-2 p-4 gap-6">
          ...
          <div class="col-span-1">
            ...
            <input type="text" id="" name=""
              ...
              placeholder="Week 1 - Content Orientation">
          </div>
          ...
          <div class="col-span-1">
            ...
            <input
              class="block w-full text-sm text-deep-koamaru border border-lavender rounded-lg cursor-pointer bg-ghost-white focus:outline-none"
              aria-describedby="file_input" id="file_input" type="file" multiple>
          ...
          <div class="col-span-1 pt-2">
            <button
              ...
              data-modal-target="create-quiz-modal" data-modal-toggle="create-quiz-modal">
          ...
          <!-- Create Quiz Modal -->
          <div id="create-quiz-modal" tabindex="-1" aria-hidden="true"
              ...
              <div class="relative bg-white rounded-2xl shadow">
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t border-indigo-100">
                  ...
                  <button type="button" id=""
                    ...
                    data-modal-toggle="create-quiz-modal" data-modal-hide="create-quiz-modal">
                ...
                <div class="p-4 md:p-5">
                  <div class="flex flex-col justify-end items-center gap-4 px-5 mb-6">
                    ...
                    <div class="space-y-6 w-full max-w-[70rem] p-4 border-t rounded-t border-indigo-100 pt-9">
                      <!-- Question 1 -->
                      <span
                        class="mt-4 items-center bg-ghost-lavender text-neon-blue text-sm font-medium px-4 py-2 rounded-lg">
                        Question # 1
                      </span>
                      <!-- Question -->
                  ...
                  <div class="border-t border-indigo-100 pt-6">
                    <!-- Register button -->
                    <button data-modal-target="quiz-confirmation-modal" data-modal-toggle="quiz-confirmation-modal"
                      type="button" id=""
                      class="text-white bg-neon-blue hover:bg-free-speech-blue focus:ring-4 focus:outline-none focus:ring-perano font-medium rounded-md text-sm px-5 py-2.5 text-center transition ease-in-out duration-300 hover:scale-105">Create</button>
                    <!-- Cancel button -->
                    <button data-modal-toggle="cancel-quiz-modal" data-modal-target="cancel-quiz-modal" type="button"
                  ...
                  <div id="quiz-confirmation-modal" tabindex="-1"
                    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-0rem)] max-h-full backdrop-blur-sm bg-ghost-lavender bg-opacity-50">
                      ...
                      <div class="relative bg-white rounded-2xl py-7 px-7">
                        <div class="p-4 md:p-5">
                          ...
                          <h3 class="mb-8 text-md font-normal text-deep-koamaru text-center">By proceeding with this
                            action, you ensure all necessary approvals have been obtained and that the implications of
                            this
                            addition have been thoroughly considered.</h3>
                          <form action="" method="">
                            <div class="flex gap-4 pt-8">
                              <!-- Cancel -->
                              <button data-modal-hide="quiz-confirmation-modal" type="button"
                              ...
                              <!-- Continue -->
                              <button type="submit" data-modal-target="quiz-success-modal"
                                data-modal-hide="quiz-confirmation-modal" data-modal-toggle="quiz-success-modal"
                                class="w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none text-base focus:ring-blue-300 font-medium rounded-md px-5 py-2.5 text-center transition ease-in-out duration-300 hover:scale-105">Submit</button>
                            </div>
                          </form>
                        </div>
                      </div>
                  ...
                  <!-- // Create Quiz Confirmation Modal -->
                  <!-- Quiz Success Modal -->
                  <div id="quiz-success-modal" tabindex="-1"
                    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-0rem)] max-h-full backdrop-blur-sm bg-ghost-lavender bg-opacity-50">
                    <div class="relative p-4 w-full max-w-md max-h-full">
                      <div class="relative bg-white rounded-2xl py-8">
                        <div class="p-4 md:p-5">
                          ...
                          <h3 class="mb-12 text-lg font-normal text-deep-koamaru text-center">Quiz created successfully!
                          </h3>
                          <div class="flex justify-center">
                            <button data-modal-hide="quiz-success-modal" type="button" id=""
                  ...
                  <!-- // Quiz Success Modal -->
                  <!-- Cancel Quiz Modal -->
                  <div id="cancel-quiz-modal" tabindex="-1"
                    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-0rem)] max-h-full backdrop-blur-sm bg-ghost-lavender bg-opacity-50">
                    <div class="relative p-4 w-full max-w-md max-h-full">
                      <div class="relative bg-white rounded-2xl py-7 px-7">
                        <div class="p-4 md:p-5">
                          ...
                          <form onsubmit="">
                            <h3 class="mb-12 text-lg font-normal text-deep-koamaru text-center px-6">Are you sure you
                              want to
                              go back? All inputs will not be restored.
                            </h3>
                            <div class="gap-4 flex justify-center">
                              <button data-modal-hide="cancel-quiz-modal" id="konperm"
                                data-modal-toggle="cancel-quiz-modal"
                                class="text-white bg-red-500 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-lg font-medium inline-flex items-center px-7 py-2.5 text-center transition duration-300 ease-in-out hover:scale-105">
                                Yes
                              </button>
                              <button data-modal-hide="cancel-quiz-modal" id="kansel" type="button"
        ...
        <div class="py-4 pl-4">
          <!-- Submit button -->
          <button data-modal-target="submit-confirmation-modal" data-modal-toggle="submit-confirmation-modal"
            type="button" id=""
            class="text-white bg-neon-blue hover:bg-free-speech-blue focus:ring-4 focus:outline-none focus:ring-perano font-medium rounded-md text-sm px-5 py-2.5 text-center transition ease-in-out duration-300 hover:scale-105">Submit</button>
          <!-- Cancel button -->
          <button data-modal-target="cancel-modal" data-modal-toggle="cancel-modal" type="button"
            class="ms-3 text-neon-blue bg-ghost-lavender hover:bg-lavender-blue focus:ring-4 focus:outline-none focus:ring-deep-lav-blue rounded-md text-sm font-medium px-5 py-2.5 focus:z-10 transition duration-300 ease-in-out hover:scale-105">Cancel</button>
        </div>
        <!-- // footer -->
        <!-- Submit Confirmation Modal -->
        <div id="submit-confirmation-modal" tabindex="-1"
          class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-0rem)] max-h-full backdrop-blur-sm bg-ghost-lavender bg-opacity-50">
          <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-2xl py-7 px-7">
              <div class="p-4 md:p-5">
                ...
                <form action="" method="">
                  <div class="flex gap-4 pt-8">
                    <!-- Cancel -->
                    <button data-modal-hide="submit-confirmation-modal" type="button"
                      class="w-full text-deep-koamaru bg-transparent focus:outline-none hover:bg-ghost-lavender border border-purple-blue focus:ring-4 focus:ring-perano font-medium rounded-md text-base px-5 py-2.5 transition ease-in-out duration-300 hover:scale-105">Cancel</button>
                    <!-- Continue -->
                    <button type="submit" data-modal-target="submit-success-modal"
                      data-modal-hide="submit-confirmation-modal" data-modal-toggle="submit-success-modal"
                      class="w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none text-base focus:ring-blue-300 font-medium rounded-md px-5 py-2.5 text-center transition ease-in-out duration-300 hover:scale-105">Submit</button>
                  </div>
                </form>
              </div>
        ...
        <div id="submit-success-modal" tabindex="-1"
          class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-0rem)] max-h-full backdrop-blur-sm bg-ghost-lavender bg-opacity-50">
          <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-2xl py-8">
              <div class="p-4 md:p-5">
                ...
                <h3 class="mb-12 text-lg font-normal text-deep-koamaru text-center">Course content submitted
                  successfully!</h3>
                <div class="flex justify-center">
                  <button data-modal-hide="submit-success-modal" type="button" id=""
                    class="text-white bg-green-500 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-lg font-medium inline-flex items-center px-7 py-2.5 text-center transition duration-300 ease-in-out hover:scale-105">
                    OK
                  </button>
                </div>
            ...
            <div class="relative bg-white rounded-2xl py-7 px-7">
              <div class="p-4 md:p-5">
                ...
                <form onsubmit="">
                  ...
                  <div class="gap-4 flex justify-center">
                    <a href="./course-content-management.php" data-modal-hide="cancel-modal"
                      class="text-white bg-red-500 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-lg font-medium inline-flex items-center px-7 py-2.5 text-center transition duration-300 ease-in-out hover:scale-105">
                      Yes
                    </a>
