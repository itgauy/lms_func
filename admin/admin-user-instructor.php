...
if (isset($_GET['sn'])) {
  ...
  $studentNum = $_GET['sn'];
  $sql = "SELECT * FROM Instructors_Tbl WHERE EmployeeNum = '$studentNum'";
          ...
          <div class="max-h-[480px] overflow-y-auto">
            <table class="w-full text-sm text-left rtl:text-right text-deep-koamaru">
              ...
              <tbody>
                ...
                $sql = "SELECT s.* FROM Instructors_Tbl s JOIN Users_Tbl u ON s.Username = u.Username WHERE u.Status='ACTIVE' ORDER BY updated_at DESC";
                $result = $conn->query($sql);
        ...
        <div id="edit-student-modal" data-modal-backdrop="static" tabindex="-1"
          ...
          <div class="relative w-full max-w-4xl max-h-full">
            ...
            <div class="relative bg-white rounded-2xl shadow py-4">
              ...
              <!-- Modal body -->
              <!-- Your edit form here -->
              <form class="p-6 bg-white" action="../models/edit_instructor.php" method="post">
                <div class="grid gap-6 mb-6 md:grid-cols-7">
                  <!-- Employee number -->
                  <div class="col-span-2">
                    <label for="req" class="text-sm font-medium text-red-500"><b>
          ...
          <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-2xl py-8">
              <div class="p-4 md:p-5">
                ...
                <h3 class="mb-12 text-lg font-normal text-deep-koamaru text-center">Instructor Account Deactivated
                  successfully!
                </h3>
                <div class="flex justify-center">
          ...
          <div class="max-h-[480px] overflow-y-auto">
            <table class="w-full text-sm text-left rtl:text-right text-deep-koamaru">
              ...
              <tbody>
                ...
                $sql = "SELECT s.* FROM Instructors_Tbl s JOIN Users_Tbl u ON s.Username = u.Username WHERE u.Status='INACTIVE' ORDER BY updated_at DESC";
                $result = $conn->query($sql);
          ...
          <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-2xl py-8">
              <div class="p-4 md:p-5">
                ...
                <h3 class="mb-12 text-lg font-normal text-deep-koamaru text-center">Instructor Account Reactivated
                  Successfully!
                </h3>
                <div class="flex justify-center">
                  <button data-modal-hide="unenroll-success-modal" type="button"
  ...
  <script>
    $(document).ready(function () {
      $('.edit-button').click(function () {
        ...
        $.ajax({
          url: 'admin-user-instructor.php', // The PHP file that fetches the data
          type: 'get',
          data: { sn: EmployeeNum },
          success: function (response) {
