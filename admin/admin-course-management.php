  ...
  <div class="p-4 sm:ml-64">
    <div class="pt-4 px-5 rounded-2xl mt-14">
      ...
      <button
        ...
        data-modal-target="add-course-modal" data-modal-toggle="add-course-modal">
      ...
      <!-- Add Course Modal -->
      <div id="add-course-modal" tabindex="-1"
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
          <div class="relative bg-white rounded-2xl py-7 px-7">
            <div class="p-4 md:p-5">
              ...
              <h3 class="mb-8 text-lg font-normal text-deep-koamaru text-center px-6">By proceeding with this action,
                you ensure all necessary approvals have been obtained and that the implications of this addition have
              ...
              <input type="text" id="first-name"
                ...
                placeholder="SE101" required><br>
              <!-- Course Title -->
              <label for="student-number" class="block mb-2 text-sm font-medium text-deep-koamaru">Course
                Title:</label>
              <input type="text" id="first-name"
                class="bg-ghost-white border border-lavender text-deep-koamaru text-sm rounded-lg focus:ring-neon-blue focus:border-neon-blue block w-full p-2.5 placeholder-moody-blue transition ease-in-out duration-300"
                placeholder="Software Engineering" required><br>
              <!-- Course Unit -->
              <label for="student-number" class="block mb-2 text-sm font-medium text-deep-koamaru">Course
                Unit:</label>
              <input type="text" id="first-name"
              ...
              <div class="flex gap-4 pt-8">
                <!-- Cancel -->
                <button data-modal-hide="add-course-modal" type="button"
                ...
                <!-- Continue -->
                <button data-modal-hide="add-course-modal" data-modal-target="add-course-success-modal"
                  data-modal-toggle="add-course-success-modal" type="submit"
      ...
      <div id="add-course-success-modal" tabindex="-1"
        class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-0rem)] max-h-full backdrop-blur-sm bg-ghost-lavender bg-opacity-50">
        <div class="relative p-4 w-full max-w-md max-h-full">
          <div class="relative bg-white rounded-2xl py-8">
            <div class="p-4 md:p-5">
              ...
              <div class="flex justify-center">
                <button data-modal-hide="add-course-success-modal" type="button"
      ...
      <div class="grid grid-cols-3 mt-12 gap-6">
        ...
        <div
          ...
          <div class="flex justify-between items-center mt-4">
            ...
            <!-- Action Buttons -->
            <button type="button" id="dropdown-menu-1" data-dropdown-toggle="dropdown-menu"
        ...
        <div id="dropdown-menu" class="z-10 hidden bg-white divide-y divide-indigo-100 rounded-lg drop-shadows w-auto">
          <ul class="py-2 text-sm text-deep-koamaru" aria-labelledby="dropdown-menu-1">
            <li>
              <button
                class="w-full px-4 py-2 font-medium hover:bg-ghost-white hover:text-neon-blue transtion duration-300 ease-in-out"
                data-modal-target="edit-course-modal" data-modal-toggle="edit-course-modal">Edit
                Course</a>
              </button>
            </li>
            <li>
              <button
                class="w-full px-4 py-2 font-medium hover:bg-ghost-white hover:text-neon-blue transtion duration-300 ease-in-out"
                data-modal-target="archive-course-modal" data-modal-toggle="archive-course-modal">Archive
                Course</a>
              </button>
            </li>
          </ul>
        ...
        <!-- // Dropdown Content for Course -->
        <!-- Edit Course Modal -->
        <div id="edit-course-modal" tabindex="-1"
          class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-0rem)] max-h-full backdrop-blur-sm bg-ghost-lavender bg-opacity-50">
          <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-2xl py-7 px-7">
              <div class="p-4 md:p-5">
                ...
                <div class="flex gap-4 pt-8">
                  <!-- Cancel -->
                  <button data-modal-hide="edit-course-modal" type="button"
                    class="w-full text-deep-koamaru bg-transparent focus:outline-none hover:bg-ghost-lavender border border-purple-blue focus:ring-4 focus:ring-perano font-medium rounded-md text-base px-5 py-2.5 transition ease-in-out duration-300 hover:scale-105">Cancel</button>
                  <!-- Continue -->
                  <button data-modal-hide="edit-course-modal" data-modal-target="edit-course-success-modal"
                    data-modal-toggle="edit-course-success-modal" type="submit"
        ...
        <div id="edit-course-success-modal" tabindex="-1"
          class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-0rem)] max-h-full backdrop-blur-sm bg-ghost-lavender bg-opacity-50">
          <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-2xl py-8">
              <div class="p-4 md:p-5">
                ...
                <div class="flex justify-center">
                  <button data-modal-hide="edit-course-success-modal" type="button"
                    class="text-white bg-green-500 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-lg font-medium inline-flex items-center px-7 py-2.5 text-center transition duration-300 ease-in-out hover:scale-105">
                    OK
                  </button>
                </div>
        ...
        <div id="archive-course-modal" tabindex="-1"
          class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-0rem)] max-h-full backdrop-blur-sm bg-ghost-lavender bg-opacity-50">
          <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-2xl py-7 px-7">
              <div class="p-4 md:p-5">
                ...
                <h3 class="mb-12 text-lg font-normal text-deep-koamaru text-center px-6">Are you sure you want to
                  archive this account? To confirm, type <b>SE101</b> in the box below.</h3>
                <label for="student-number" class="block mb-2 text-sm font-medium text-deep-koamaru">Enter Here:</label>
                <input type="text" id="first-name"
                  class="bg-ghost-white border border-lavender text-deep-koamaru text-sm rounded-lg focus:ring-neon-blue focus:border-neon-blue block w-full p-2.5 placeholder-moody-blue transition ease-in-out duration-300"
                  placeholder="" required>
                <div class="flex gap-4 pt-8">
                  <!-- Cancel -->
                  <button data-modal-hide="archive-course-modal" type="button"
                    class="w-full text-deep-koamaru bg-transparent focus:outline-none hover:bg-ghost-lavender border border-purple-blue focus:ring-4 focus:ring-perano font-medium rounded-md text-base px-5 py-2.5 transition ease-in-out duration-300 hover:scale-105">Cancel</button>
                  <!-- Continue -->
                  <button data-modal-hide="archive-course-modal" data-modal-target="archive-course-success-modal"
                    data-modal-toggle="archive-course-success-modal" type="submit"
        ...
        <div id="archive-course-success-modal" tabindex="-1"
          class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-0rem)] max-h-full backdrop-blur-sm bg-ghost-lavender bg-opacity-50">
          <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-2xl py-8">
              <div class="p-4 md:p-5">
                ...
                <div class="flex justify-center">
                  <button data-modal-hide="archive-course-success-modal" type="button"
                    class="text-white bg-green-500 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-lg font-medium inline-flex items-center px-7 py-2.5 text-center transition duration-300 ease-in-out hover:scale-105">
                    OK
                  </button>
                </div>
