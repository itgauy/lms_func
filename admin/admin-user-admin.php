...
if (isset($_GET['sn'])) {
  ...
  $studentNum = $_GET['sn'];
  $sql = "SELECT * FROM Admins_Tbl WHERE EmployeeNum = '$studentNum'";
...
<body class="bg-ghost-white">
        ...
        <div id="register-modal" data-modal-backdrop="static" tabindex="-1"
          ...
          <div class="relative w-full max-w-4xl max-h-full">
            ...
            <div class="relative bg-white rounded-2xl shadow py-4">
              ...
              <!-- Modal body -->
              <form class="p-6 bg-white" action="../models/add_admin.php" method="post">
          ...
          <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-2xl py-8">
              <div class="p-4 md:p-5">
                ...
                <h3 class="mb-12 text-lg font-normal text-center text-deep-koamaru">Admin account registered
                  successfully!</h3>
          ...
          <div class="max-h-[480px] overflow-y-auto">
            <table class="w-full text-sm text-left rtl:text-right text-deep-koamaru">
              ...
              <tbody>
                ...
                $sql = "SELECT s.* FROM Admins_Tbl s JOIN Users_Tbl u ON s.Username = u.Username WHERE u.Status='ACTIVE' ORDER BY updated_at DESC";
                $result = $conn->query($sql);
        ...
        <div id="edit-student-modal" data-modal-backdrop="static" tabindex="-1"
          ...
          <div class="relative w-full max-w-4xl max-h-full">
            ...
            <div class="relative bg-white rounded-2xl shadow">
              ...
              <!-- Modal body -->
              <!-- Your edit form here -->
              <form class="p-6 bg-white" action="../models/edit_admin.php" method="post">
                <div class="grid gap-6 mb-6 md:grid-cols-7">
                  <!-- Employee number -->
                  <div class="col-span-2">
                    <label for="req" class="text-sm font-medium text-red-500"><b>
          ...
          <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-2xl py-8">
              <div class="p-4 md:p-5">
                ...
                <h3 class="mb-12 text-lg font-normal text-center text-deep-koamaru">Admin account edited
                  successfully!</h3>
                <div class="flex justify-center">
                  <button data-modal-hide="edit-success-modal" type="button" id="oktyyy1"
                    class="text-white bg-green-500 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-lg font-medium inline-flex items-center px-7 py-2.5 text-center transition duration-300 ease-in-out hover:scale-105">
                    OK
                  </button>
                </div>
          ...
          <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-2xl py-8">
              <div class="p-4 md:p-5">
                ...
                <h3 class="mb-12 text-lg font-normal text-deep-koamaru text-center">Admin Account Deactivated
                  successfully!
                </h3>
                <div class="flex justify-center">
          ...
          <div class="max-h-[480px] overflow-y-auto">
            <table class="w-full text-sm text-left rtl:text-right text-deep-koamaru">
              ...
              <tbody>
                ...
                $sql = "SELECT s.* FROM Admins_Tbl s JOIN Users_Tbl u ON s.Username = u.Username WHERE u.Status='INACTIVE' ORDER BY updated_at DESC";
                $result = $conn->query($sql);
                ...
                if ($result->num_rows > 0) {
                  ...
                  while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<td class="px-4 py-4 truncate">' . $row["EmployeeNum"] . "</td>";
                    echo '<td class="px-4 py-4 truncate">' . $row["Department"] . "</td>";
                    echo "<td class='flex items-center px-4 py-4'><button data-modal-target='enroll-modal' data-modal-toggle='enroll-modal' class='enrolls font-medium text-blue-600 dark:text-blue-500 hover:underline'>Reactivate</button>";
                    echo "<button onclick=\"openArchiveModal('" . $row["EmployeeNum"] . "', '" . $row["Username"] . "')\" data-modal-target='archive-modal' data-modal-toggle='archive-modal' class='archives font-medium text-red-600 dark:text-red-500 hover:underline ms-3'>Archive</button></td>";
                    echo "</td>";
                    echo "</tr>";
                  }
                } else {
          ...
          <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-2xl py-8">
              <div class="p-4 md:p-5">
                ...
                <h3 class="mb-12 text-lg font-normal text-deep-koamaru text-center">Admin Account Reactivated
                  Successfully!
                </h3>
                <div class="flex justify-center">
                  <button data-modal-hide="unenroll-success-modal" type="button"
  ...
  <script>
    ...
    var okButton1 = document.getElementById("oktyyy1");
    ...
    okButton.addEventListener("click", function () {
      ...
      history.pushState({}, null, "http://localhost/lms/admin/admin-user-admin");
    });
  ...
  <script>
    $(document).ready(function () {
      $('.edit-button').click(function () {
        ...
        var EmployeeNum = row.find('td:eq(1)').text(); // Adjust the index based on your table structure

        // my fav AJAX to fetch data
        $.ajax({
          url: 'admin-user-admin.php', // The PHP file that fetches the data
          type: 'get',
          data: { sn: EmployeeNum },
          success: function (response) {
