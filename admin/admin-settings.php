          ...
          <ul class="flex flex-wrap -mb-px text-sm font-medium text-center transition duration-300 ease-in-out"
            ...
            <li class="me-2" role="presentation">
              <button
                ...
                id="account-profile-tab" data-tabs-target="#account-profile" type="button" role="tab"
                aria-controls="account-profile" aria-selected="false">Account Profile</button>
            </li>
            <li class="me-2" role="presentation">
              <button
                class="inline-block px-4 py-2 hover:bg-ghost-lavender transition duration-300 ease-in-out border-b-2 rounded-t-lg"
          ...
          <div class="hidden space-y-5" id="account-profile" role="tabpanel" aria-labelledby="account-profile-tab">
            ...
            <div class="inline-flex rounded-2xl bg-white drop-shadows overflow-y-auto space-y-4">
              <div class="px-8 py-5 flex items-center gap-5">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                  class="w-24 h-24 text-corn-flower-blue">
                ...
                <div class="space-y-2 text-center">
                  <span
                    class="text-neon-blue font-bold text-2xl bg-ghost-lavender px-3 py-1 rounded-md"><?php echo $_SESSION['employeenum']; ?></span>
                  <span class="block text-deep-koamaru font-medium text-sm"><?php echo $_SESSION['dept']; ?>
                    Department</span>
                </div>
              </div>
            </div>
            ...
            <div class="grid gap-6 mb-6 grid-cols-3">
              ...
              <div class="col-start-1 col-span-4">
                <div
                  class="block rounded-2xl bg-white shadow-[10px_10px_30px_-16px_rgba(224,227,246)] overflow-y-auto space-y-4 p-8">
                  ...
                  <div class="grid grid-cols-5 pt-4">
                    ...
                    <div class="space-y-2.5 col-span-1">
                      ...
                      <span class="block text-deep-koamaru font-medium"><?php echo $_SESSION['fname']; ?></span>
                    </div>
                    <!-- Middle Name  -->
                    <div class="space-y-2.5 col-span-1">
                      <span class="block text-slate-500">Middle name</span>
                      <span class="block text-deep-koamaru font-medium"><?php echo $_SESSION['mname']; ?></span>
                    </div>
                    <!-- Last Name -->
                    <div class="space-y-2.5 col-span-1">
                      <span class="block text-slate-500">Last name</span>
                      <span class="block text-deep-koamaru font-medium"><?php echo $_SESSION['lname']; ?></span>
                    </div>
                    <!-- Suffix -->
                    <div class="space-y-2.5 col-span-1">
                      <span class="block text-slate-500">Suffix</span>
                      <span class="block text-deep-koamaru font-medium"><?php echo $_SESSION['suffix']; ?></span>
                    </div>
                    <!-- Date of Birth -->
                    <div class="space-y-2.5 col-span-1">
                      <span class="block text-slate-500">Date of Birth</span>
                      <span class="block text-deep-koamaru font-medium"><?php echo $_SESSION['dob']; ?></span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div
                  ...
                  <div class="grid grid-cols-7 pt-4">
                    ...
                    <div class="space-y-2.5 col-span-1">
                      ...
                      <span class="block text-deep-koamaru font-medium"><?php echo $_SESSION['email']; ?></span>
                    </div>
                    <!-- Username  -->
                    <div class="space-y-2.5 col-start-3">
                      <span class="block text-slate-500">Username</span>
                      <span class="block text-deep-koamaru font-medium"><?php echo $_SESSION['user']; ?></span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="w-1/2 m-auto">
              ...
              <div class="flex flex-col justify-center items-center">
                <div class="w-full max-w-sm p-4 bg-white rounded-2xl drop-shadows sm:p-6 md:p-8">
                  <form class="space-y-3" action="../models/change_username.php" method="post">
                    <h5 class="text-xl font-medium text-deep-koamaru mb-3">Change Username</h5>
                    <p class="block text-sm font-normal text-deep-koamaru pb-5">Lorem ipsum dolor sit amet, consectetur
                      adipis.</p>
                    <label for="current_pass" class="block text-sm font-medium text-deep-koamaru">Current
                      Password</label>
                    ...
                    <label for="new_username" class="block text-sm font-medium text-deep-koamaru pt-4">New
                      Username</label>
                    <!-- New Username -->
                    <input type="text" id="new_username" name="new_username"
                      class="bg-ghost-white border border-lavender text-deep-koamaru text-sm rounded-md focus:ring-neon-blue focus:border-neon-blue block w-full p-2.5 placeholder-moody-blue transition ease-in-out duration-300"
                      placeholder="New username" required><br>
                    <!-- Error Message for validation -->
                    <?php if (isset($_SESSION['error'])): ?>
                      <p class="text-sm text-red-600 dark:text-red-500"><span class="font-medium">Oh, snapp!</span>
            ...
            <div class="flex flex-col justify-center items-center">
              <div class="w-full max-w-sm p-4 bg-white rounded-2xl drop-shadows sm:p-6 md:p-8">
                <form class="space-y-3" action="#">
                  ...
                  <input type="text" id=""
                    class="bg-ghost-white border border-lavender text-deep-koamaru text-sm rounded-md focus:ring-neon-blue focus:border-neon-blue block w-full p-2.5 placeholder-moody-blue transition ease-in-out duration-300"
                    placeholder="New email address" required><br>
                  <!-- Error Message for validation -->
                  <!-- <p class="text-sm text-red-600 dark:text-red-500"><span class="font-medium">Oh, snapp!</span> Some error message.</p> -->
                  <!-- Submit Button -->
                  <button type="submit"
