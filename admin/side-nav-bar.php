...
<body class="bg-ghost-white">
              ...
              <div class="relative p-4 w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-2xl py-7 px-7">
                  <div class="p-4 md:p-5">
                    ...
                    <form onsubmit="return checkArchiveNumber()" id="noReload">
                      ...
                      <div class="flex gap-4 pt-8">
                        <!-- Cancel -->
                        <button data-modal-hide="archive-program-modal" type="button" id="removeLabelList"
                          class="w-full text-deep-koamaru bg-transparent focus:outline-none hover:bg-ghost-lavender border border-purple-blue focus:ring-4 focus:ring-perano font-medium rounded-md text-base px-5 py-2.5 transition ease-in-out duration-300 hover:scale-105">Cancel</button>
                        <!-- Continue -->
                        <button onclick="checkArchiveNumber()" type="submit"
  ...
  <div id="section-modal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-xl max-h-full">
      ...
      <div class="relative bg-ghost-white rounded-2xl shadow">
        ...
        <div class="p-4 md:p-5">
          <div class="flex justify-end items-center gap-4 px-5 mb-6">
            ...
            <button
              ...
              data-modal-target="remove-section-modal" data-modal-toggle="remove-section-modal">
        ...
        <!-- Add Section Modal -->
        <div id="add-section-modal" tabindex="-1"
          class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-0rem)] max-h-full backdrop-blur-sm bg-ghost-lavender bg-opacity-50">
          <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-2xl py-7 px-7">
              <div class="p-4 md:p-5">
                ...
                <form action="" method="">
                  <div class="flex gap-4 pt-8">
                    ...
                    <button data-modal-hide="add-section-modal" type="button"
                      class="w-full text-deep-koamaru bg-transparent focus:outline-none hover:bg-ghost-lavender border border-purple-blue focus:ring-4 focus:ring-perano font-medium rounded-md text-base px-5 py-2.5 transition ease-in-out duration-300 hover:scale-105">Cancel</button>
                    <!-- Continue -->
                    <button type="submit" data-modal-target="add-section-success-modal"
                      data-modal-hide="add-section-modal" data-modal-toggle="add-section-success-modal"
                      class="w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none text-base focus:ring-blue-300 font-medium rounded-md px-5 py-2.5 text-center transition ease-in-out duration-300 hover:scale-105">Add</button>
                  </div>
                </form>
              </div>
        ...
        <div id="add-section-success-modal" tabindex="-1"
          class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-0rem)] max-h-full backdrop-blur-sm bg-ghost-lavender bg-opacity-50">
          <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-2xl py-8">
              <div class="p-4 md:p-5">
                ...
                <div class="flex justify-center">
                  <button data-modal-hide="add-section-success-modal" type="button"
                    class="ok-section text-white bg-green-500 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-lg font-medium inline-flex items-center px-7 py-2.5 text-center transition duration-300 ease-in-out hover:scale-105">
                    OK
                  </button>
                </div>
              </div>
        ...
        <div id="remove-section-modal" tabindex="-1"
          class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-0rem)] max-h-full backdrop-blur-sm bg-ghost-lavender bg-opacity-50">
          <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-2xl py-7 px-7">
              <div class="p-4 md:p-5">
                ...
                <form action="" method="">
                  <div class="flex gap-4 pt-8">
                    <!-- Cancel -->
                    <button data-modal-hide="remove-section-modal" type="button"
                      class="w-full text-deep-koamaru bg-transparent focus:outline-none hover:bg-ghost-lavender border border-purple-blue focus:ring-4 focus:ring-perano font-medium rounded-md text-base px-5 py-2.5 transition ease-in-out duration-300 hover:scale-105">Cancel</button>
                    <!-- Continue -->
                    <button type="submit" data-modal-target="remove-section-success-modal"
                      data-modal-hide="remove-section-modal" data-modal-toggle="remove-section-success-modal"
                      class="w-full text-white bg-red-500 hover:bg-red-600 focus:ring-4 focus:outline-none text-base focus:ring-red-300 font-medium rounded-md px-5 py-2.5 text-center transition ease-in-out duration-300 hover:scale-105">Remove</button>
                  </div>
                </form>
              </div>
            </div>
        ...
        <div id="remove-section-success-modal" tabindex="-1"
          class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-0rem)] max-h-full backdrop-blur-sm bg-ghost-lavender bg-opacity-50">
          <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-2xl py-8">
              <div class="p-4 md:p-5">
                ...
                <div class="flex justify-center">
                  <button data-modal-hide="remove-section-success-modal" type="button"
                    class="ok-section text-white bg-green-500 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-lg font-medium inline-flex items-center px-7 py-2.5 text-center transition duration-300 ease-in-out hover:scale-105">
                    OK
                  </button>
                </div>
  ...
  <script>
    ...
    var remub = document.getElementById('removeLabelList');
