        ...
        <div class="flex items-center">
          ...
          <div class="flex items-center ms-3">
            <div>
              ...
              <!-- Sign Out Modal -->
              <div id="sign-out-modal" tabindex="-1"
                ...
                <div class="relative p-4 w-full max-w-md max-h-full">
                  <div class="relative bg-white rounded-2xl py-8">
                    <div class="p-4 md:p-5 text-center space-x-4">
                      ...
                      <a href="../models/logout.php/" data-modal-hide="sign-out-modal" type="button"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-lav-sant">
      <ul class="space-y-2 font-medium">
        ...
        <ul id="dropdown-programs" class="hidden py-2 space-y-2">
          <li>
            <a href="./instructor-course-overview.php" data-popover-target="first-subject" type="button"
