...
<head>
  ...
  <title>Learning Management System | Instructor Dashboard</title>
  <!-- Tailwind cdn -->
...
<body class="bg-ghost-white">
  <div class="p-4 sm:ml-64 sm:mr-[22rem]">
    <div class="pt-4 pl-4 mt-14">
      ...
      <!--  Enrolled Course -->
      <h1 class="font-bold text-4xl pb-6 text-corn-flower-blue mt-8 mb-2">Courses</h1>
      <div class="grid grid-cols-2 gap-5 mb-6" id='draggable-elements'>
        <!-- Course Card -->
        <a href="./instructor-course-overview.php"
