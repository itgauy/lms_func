            ...
            <div class="inline-flex rounded-2xl bg-white drop-shadows overflow-y-auto space-y-4">
              <div class="px-8 py-5 flex items-center gap-5">
                ...
                <div class="space-y-2 text-center">
                  <span class="text-neon-blue font-bold text-2xl bg-ghost-lavender px-3 py-1 rounded-md">22-0047</span>
                ...
                <div
                  ...
                  <div class="grid grid-cols-5 pt-4">
                    ...
                    <div class="space-y-2.5 col-span-1">
                      ...
                      <span class="block text-deep-koamaru font-medium">John Mark</span>
                    </div>
                    <!-- Middle Name  -->
                    <div class="space-y-2.5 col-span-1">
                    ...
                    <div class="space-y-2.5 col-span-1">
                      ...
                      <span class="block text-deep-koamaru font-medium">Dela Cruz</span>
                    </div>
                    <!-- Suffix -->
                    <div class="space-y-2.5 col-span-1">
                    ...
                    <div class="space-y-2.5 col-span-1">
                      ...
                      <span class="block text-deep-koamaru font-medium">January 17, 2004</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div
                  ...
                  <div class="grid grid-cols-7 pt-4">
                    ...
                    <div class="space-y-2.5 col-span-1">
                      ...
                      <span class="block text-deep-koamaru font-medium">delacruzjohnmarkgiron@gmail.com</span>
                    </div>
                    <!-- Username  -->
                    <div class="space-y-2.5 col-start-3">
                      <span class="block text-slate-500">Username</span>
                      <span class="block text-deep-koamaru font-medium">20040117220047</span>
                    </div>
                  </div>
                </div>
              </div>
