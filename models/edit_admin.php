...
$sql = "UPDATE Admins_Tbl SET FirstName='$fname', MiddleName='$mname', LastName='$lname', Suffix='$suffix', BirthDate='$dob', Department='$dept', Email='$email', Username='$username' WHERE EmployeeNum='$sn';";
...
if ($conn->multi_query($sql) === TRUE) {
  ...
  // INSERT LOG HERE :)))))))
  insert_log($_SESSION['Username'], 'Administrator', 'Admin Account Update', $username);
  header('Location: ../admin/admin-user-admin?showModalEdit=true');
} else {
